                ...
                <div class="container">
                        ...
                        <div class="event-details-left ">
                            <div class="d-flex gap-2 mb-3">
                                <div class="event-yellow bg-pale-goldenrod d-flex align-items-center justify-content-center">
                                    <p class="mb-0 ls-1 text-dark1 px-1 fw-semiBold ff-inter fs-12">Event</p>
                                </div>
                                <div class="event-gray bg-gray-2 d-flex align-items-center justify-content-center">
                                    <p class=" text-dark2 fw-semiBold px-1 fs-12 mb-0 ff-inter ls-1">Identity and Language</p>
                                </div>
                            </div>
                            <div class="event-heading">
                                <h2 class="fs-48 lh-58 text-dark1 mb-4">International exchange skill events only better japanese language</h2>
                            </div>
                            <div class="event-information">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="view d-flex align-items-center">
                                        <p class=" text-dark2 fs-14 fw-medium ff-inter mb-0">€48 Per Person</p>
                                    </div>
                                    <div class="line"></div>
                                    ...
                                    <div class="review d-flex align-items-center gap-3">
                                        ...
                                        <p class=" text-dark2 fs-14 fw-medium ff-inter mb-0">480 Followers</p>
                                    </div>
                                    <div class="line"></div>
                    ...
                    <div class="blog-details-wrapper mt-5 d-flex align-items-center justify-content-center gap-3">
                        <div class="blog-details-img">
                            <img src={EventImg} class="img-fluid" alt="blog-details" />
                        </div>
                        <div class="blog-details-img">
                            <img src={EventImg} class="img-fluid" alt="blog-details" />
                        </div>
