              ...
              {categoryList.map((cat) => (
                <div className="col-md-6" key={cat.categoryName}>
                  <div
                    ...
                    className="mb-3 d-flex justify-content-between align-items-center radio-cat-wrapper"
                  >
                    <label
                      htmlFor="catRadio"
                      className="text-clr-dark-2 fw-semibold text-capitalize fs-6 ltr-spacing-0"
                    >
                      {cat?.categoryName}
                    </label>
                    <Form.Check
                      ...
                      name="category"
                      value={
                        updateMode ? newFormData?.category : cat?.categoryName
                      }
                      checked={
                        updateMode
                          ? newFormData.category === cat?.categoryName
