    ...
    <div>
        ...
        <div class="follower">
          <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
            ...
            <div>
              <a
                href=""
                class="text-clr-egyptian-green fs-12 fw-semiBold text-uppercase ff-inter ls-1 text-decoration-none"
              >
                See all
                <span>
      ...
      <div class="wedged-area p-4 mb-4 ff-inter bg-white">
        ...
        <div class="category-tags">
          <a
            href="#"
            class="single-category fs-12 lh-15 text-uppercase ls-1 text-dark3 fw-semiBold d-inline-block"
          >
            Art and Culture
          </a>
          <a
