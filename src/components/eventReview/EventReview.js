    ...
    return (
        <div className="blog-review-wrapper py-5">
            ...
            <div className="review-wrapper">
                <div className="inner-wrapper bg-white p-4 mb-4">
                    ...
                    <div className="review-info pb-4 border-bottom">
                        <h5 className="review-caption fs-18 text-clr-dark-2 mb-3">Fermentum Venenatis Tortor</h5>
                    ...
                    <div className="is-reply-massage p-3 border-start border-2 border-info">
                        <div className="d-flex justify-content-between">
                            <div className="d-flex gap-4">
                                ...
                                <div className="">
                                    <Link className="fw-semiBold text-clr-dark-2 d-block mb-2 fs-14" text-decoration-none>
                                        Reply from Satoshi Nakamoto
                                    </Link>
                                    <p className="fw-medium text-clr-dark-2 mb-0 fs-14">
                                        Hearing from happy customers like you makes us feel great. <br className="d-none d-xl-inline" /> Thank you for sharing your experience! If you need further help,
                                        reach out any time!
                                    </p>
                                </div>
                            </div>
                            <div className="meta-date">
                                <p className="text-clr-dark-2 fw-medium mb-0 fs-14">Aug 19, 2022</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="review-header d-flex justify-content-between border-bottom pb-4 mb-4">
                        <div className="review-header-left d-flex gap-4">
                            ...
                            <div className="">
                                ...
                                <p className="fw-medium country text-clr-dark-2 mb-0 fs-12">Australia</p>
                            </div>
                        </div>
                        <div className="meta-date">
                            <p className="text-clr-dark-2 fw-medium mb-0">Aug 19, 2022</p>
                ...
                <div className="inner-wrapper bg-white p-4 mb-4">
                    ...
                    <div className="review-info pb-4 border-bottom">
                        <h5 className="review-caption fs-18 text-clr-dark-2 mb-3">Inceptos</h5>
                        <p className="mb-0 text-clr-dark-2">
                            Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                        </p>
                    </div>
            ...
            <div className="event-details-right d-flex justify-content-center mt-5">
                <button className="btn btn-green ls-1 fs-12 text-uppercase rounded-0 fw-normal text-white mb-3 border-0 bg-green ff-inter w-auto px-5" type="button">
                    Read more
                </button>
            </div>
        </div>
