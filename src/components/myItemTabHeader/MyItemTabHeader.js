...
const MyItemTabHeader = ({ filterByType, handleReset, filterByCategory }) => {
    ...
    <div>
      <div className="events-area-header">
        <div className="d-flex align-items-center justify-content-between flex-wrap pb-2">
          <h4 className="fs-24 lh-34 fw-medium text-dark1 mb-0">
            What's happening?
          </h4>
          <PostTypeModal />
        </div>
        <div className="events-filter-area d-flex align-items-center justify-content-between mt-3 pb-4">
          <div className="d-flex align-items-center gap-2">
            ...
            <div className="reset-filters-btn">
              <Link
                className="text-decoration-none fs-12 lh-15 text-green ff-inter ls-1 fw-semiBold text-uppercase p-2 hover-color"
                onClick={handleReset}
              >
                Reset filters
              </Link>
                ...
                <div className="header-right-catalog me-sm-2">
                  <div className="dropdown">
                    <Link
                      ...
                      aria-expanded="false"
                    >
                      <span className="fw-semiBold fs-12 ff-inter d-none d-lg-block mb-0 text-uppercase text-dark2">
                        Relevance
                      </span>
                    ...
                    <div className="notify-dropdown-menu dropdown-menu px-0 py-0 position-absolute">
                      <ul className="dropdown-list-group list-group list-group-flush px-0 py-0 list-unstyled">
                        <li className="list-group-item">
                          <Link className="list-group-item-linkable text-dark2 ff-inter fs-12 fw-medium text-uppercase ls-2 d-block">
                            Date
                          </Link>
                        </li>
                        <li className="list-group-item">
