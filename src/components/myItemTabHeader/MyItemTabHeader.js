                ...
                <div className="events-filter-area d-flex align-items-center justify-content-between mt-3 pb-4">
                    <div className="d-flex align-items-center gap-2">
                                ...
                                <div className="header-right-catalog me-sm-2">
                                    <div className="dropdown">
                                        <Link
                                            ...
                                            aria-expanded="false"
                                        >
                                            <span className="fw-semiBold fs-12 ff-inter d-none d-lg-block mb-0 text-uppercase text-dark2">Any Rating</span>
                        ...
                        <div className="reset-filters-btn">
                            <button className="fs-12 lh-15 text-green ff-inter ls-1 fw-semiBold text-uppercase p-2 hover-color border-0 bg-transparent">Reset filters</button>
                        </div>
                    </div>
