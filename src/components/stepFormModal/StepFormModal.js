...
const StepFormModal = ({ setSWhowPostTypeModal, showEditMode, showCreateBtn, currentData }) => {

    const { formData, canSubmit, setFormData, loading, setLoading, updateMode, setUpdateMode } = useStepFormContext();
                    ...
                    {!loading && (
                        <form className="step-info" enctype="multipart/form-data" onSubmit={handleSubmit}>
                            <div className="step-info-details">
                                {stepNumber === 1 && <StepOne newFormData={newFormData} handleUpdateChange={handleUpdateChange} />}
                                {stepNumber === 2 && <StepTwo newFormData={newFormData} handleUpdateChange={handleUpdateChange} />}
                                {stepNumber === 3 && <StepThree newFormData={newFormData} handleUpdateChange={handleUpdateChange} />}
                                {stepNumber === 4 && <StepFour newFormData={newFormData} handleUpdateChange={handleUpdateChange} />}
                                {stepNumber === 5 && <StepFive newFormData={newFormData} handleUpdateChange={handleUpdateChange} />}
                                {stepNumber === 6 && <StepSix newFormData={newFormData} handleUpdateChange={handleUpdateChange} />}
                            </div>
