...
const StepFormModal = ({ handleModalClose, showCreateBtn, currentData }) => {
    const { user } = useAuth();
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            await axios.put(`https://global-life-api.onrender.com/api/events/allevents/${newFormData?._id}`, updateCurrentEvent);
