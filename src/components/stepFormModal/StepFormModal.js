...
// setNewFormData({ ...newFormData });
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData?.photos) {
      ...
      try {
        await axios.post(
          "https://global-life-api.onrender.com/api/uploads",
          formData?.photos
        );
      } catch (err) {
        console.log(err);
    ...
    try {
      await axios.post(
        "https://global-life-api.onrender.com/api/events/createevent",
        event
      );
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axios.put(
        `https://global-life-api.onrender.com/api/events/allevents/${data?._id}`,
        updateCurrentEvent
      );
