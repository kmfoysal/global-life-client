...
const StepFormModal = ({ showForm, setShowForm, handleCloseForm, handleShowForm, currentData }) => {
            ...
            {!loading && (
              ...
              >
                <div className="step-info-details">
                  {stepNumber === 1 && <StepOne currentData={currentData} />}
                  {stepNumber === 2 && <StepTwo currentData={currentData} />}
                  {stepNumber === 3 && <StepThree currentData={currentData} />}
                  {stepNumber === 4 && <StepFour currentData={currentData} />}
                  {stepNumber === 5 && <StepFive currentData={currentData} />}
                  {stepNumber === 6 && <StepSix currentData={currentData} />}
                </div>
