  ...
  return (
    <div>
      <Banner
        bannerBg={bannerImg}
        bannerTitle={
          "Shared local knowledge for relocated families in Portugal."
        }
        bannerIntro={
          "Global Life is the one stop shop for expats to find all the information they need to make their new move more enjoyable, easier and less hassle free."
        }
